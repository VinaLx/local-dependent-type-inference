...
So we add a premise $[[G |- A : *]]$ to \rref{s-forall-r},
...
this would be much more complicated situation, where the inversion lemmas of
...
\subsection{Equivalence of a Simplified System}
