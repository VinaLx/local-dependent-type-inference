...
\begin{figure}
  ...
  \begin{gather*}
    ...
    \end{align*} \\
    \begin{align*}
     \qquad \extract{[[e1 e2]]} &= \extract{[[e1]]} ~ \extract{[[e2]]} & % \\ % \and
      \qquad \extract{[[mu x : A. e]]} &= \mu \, x. ~ \extract{[[e]]} \\
     \qquad \extract{[[lambda x : A. e]]} &= \lambda \, x. ~ \extract{[[e]]} & % \\ % \and
      \qquad \extract{[[pi x : A. B]]} &= \Pi \, x : \extract{[[A]]}. ~ \extract{[[B]]} \\
     \qquad \extract{[[bind x : A. e]]} &= \Lambda \, x. ~ \extract{[[e]]} & % \\ % \and
      \qquad \extract{[[forall x : A. B]]} &= \forall \, x : \extract{[[A]]}. ~ \extract{[[B]]} \\
     \qquad \extract{[[castup [A] e]]} &= \castup \, \extract{[[e]]} & % \\ % \and
      \qquad \extract{[[castdn e]]} &= \castdn \, \extract{[[e]]}
    \end{align*}
  \end{gather*}
...
and subtyping in a dependently type system.\bruno{Make sure that the overview discusses
this issue.}
