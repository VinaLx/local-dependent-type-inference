...
including higher-kinds, algebraic datatypes and type classes~\cite{typeclasseskaes,typeclasseswadler}
...
kinds of dependent types are also supported in \name. GADTs~\cite{gadt1,gadt2} and
type-families~\cite{typefamilies} are more challenging as they require a more powerful
