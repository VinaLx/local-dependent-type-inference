...
crucial role when considering the subtyping relation
...
But since our system has the fixpoint operator, theoretically we could construct
...
section \ref{sec:habitability}.

Due to the complications, we assume that strengthening does not hold in our system for now.
