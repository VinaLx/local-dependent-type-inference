...
by a natural value. Secondly, in \name (following the design of PITS~\citep{yang2019pure}),
...
to mimic the typeclass\citep{typeclasseswadler,typeclasseskaes} \lstinline{Functor} in Haskell:
...
Odersky and L\"aufer's declarative type system \citep{odersky1996putting}.
...
\caption{The polymorphic subtyping relation by Odersky and L\"aufer~\citep{odersky1996putting}.}
...
Implicit Calculus of Constructions (ICC) \citep{miquel2001implicit} which also talks about
