...
\begin{table}
  ...
  \begin{tabular}{l|cccccc}
   ...
   \hline
   Dependent types & $\checkmark$ & $\checkmark$ & $\times$ & Equality\mpfootnotemark[9] & $\checkmark$ & $\checkmark$  \\
   \hline
   ...
   \hline
   Relevant arguments & $\times$ & - & $\times$ & ? & $\checkmark$ & $\times$ \\
   \hline
   Rank-n polymorphism & $\times$ & - & $\checkmark$ & $\checkmark$ & ? & $\checkmark$ \\
   \hline
