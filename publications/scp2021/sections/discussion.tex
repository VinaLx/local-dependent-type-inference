...
\end{gather*}
\noindent The \emph{reduction substitution} property breaks if we substitute $f$ to an lambda expression:
\begin{gather*}
...
this kind of conflicts entirely. Alternatively, we can only infer non-dependent function types when
