...
polymorphic type ($\forall x.\, A$) found in conventional functional languages.
...
\rref{s-forall} is added to axiomatize the subtyping relation between two universal types,
