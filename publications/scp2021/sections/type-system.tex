...
In other words, ``polymorphic types'' are naturally dependent, and $\forall$
...
and only perform reduction inside $\castdn$ terms (\rref{r-castdn}). Also, the unfol
...
discuss the reason behind the restrictions in Section \ref{sec:metatheory}.
